...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            genericFragment = ProfileFragment.newInstance(user,password);
    ...
    public void onItemSelected(Apartment apartment) {
        ...
        DetailsFragment detailsFragment = DetailsFragment.newInstance(apartment.getDescription(),apartment.getLocation(),apartment.getAmountRooms(),apartment.getArea(),apartment.getName(),apartment.getPhotos(),apartment.getPropertyType(),apartment.getValue());
        if (dFragment==null){
    ...
    public void onPreferenceInteraction() {
        Fragment genericFragment=null;
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        genericFragment = EditFragment.newInstance(user,password);
        if (genericFragment!=null){
            fragmentTransaction.replace(R.id.main_container,genericFragment);
            fragmentTransaction.commit();
        }
