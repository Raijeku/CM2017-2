...
public class MainActivity extends AppCompatActivity
    ...
    public static final String HOST_IP = "http://localhost"; //Cuando se trabaja con Servidor
    ...
    public void onItemSelected(Apartment apartment) {
        ...
        DetailsFragment detailsFragment = DetailsFragment.newInstance(apartment.getDescription(),apartment.getLocation(),apartment.getAmountRooms(),apartment.getArea(),apartment.getName(),null,apartment.getPropertyType(),apartment.getValue());
        if (dFragment==null){
