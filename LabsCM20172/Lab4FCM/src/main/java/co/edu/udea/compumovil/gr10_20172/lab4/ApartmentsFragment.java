...
public class ApartmentsFragment extends Fragment implements ApartmentAdapter.OnRecyclerItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        childEventListener=new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Apartment addedApartment = dataSnapshot.getValue(Apartment.class);
                apartments.add(addedApartment);
                mAdapter.setApartmentList(apartments);
                mRecyclerView.setAdapter(mAdapter);
                SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(getContext());
                SharedPreferences.Editor editor = sharedPref.edit();
                editor.putString("last_apartment_name", addedApartment.getName());
                editor.putString("last_apartment_type", addedApartment.getPropertyType());
                editor.putString("last_apartment_image",addedApartment.getImage());
                editor.commit();
            }
    ...
    public void onPause() {
        ...
        mAdapter.setApartmentList(new ArrayList<Apartment>());
    }

    private void detachDatabaseReadListener() {
        if (childEventListener!=null){
            apartmentsDatabaseReference.removeEventListener(childEventListener);
